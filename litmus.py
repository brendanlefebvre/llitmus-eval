...
# Some MLX versions have moved clear_cache / peak-memory helpers to the top
# level but still expose mx.metal.* as deprecated aliases that emit warnings.
# Our helpers below prefer the new names and fall back gracefully; silence
# the "deprecated" noise so benchmark output stays readable.
